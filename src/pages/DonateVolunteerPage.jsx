...
import { Heart, Users, ClipboardCheck, BookOpen, Send } from "lucide-react";
...
const DonateVolunteerPage = () => {
  const volunteerRoles = [
    ...
    },
    {
      ...
      description:
        "Assist veterinarians during treatment and vaccination drives",
      icon: ClipboardCheck,
    },
    {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            <div className="space-y-6 text-gray-600 text-lg">
              <p>
                An animal is human's best friend. And no doubt everybody has
                experienced this to be true once in their life. They give you
                all their passion and love without expecting much.
              </p>
              <p>
                To feed them with food, warmth and love is what we need to do to
                experience one of the greatest joy of giving and loving in life.
                They have their own voice and we need to hear and understand
                them, and once you do, there is no going back in giving all
                yours to them.
              </p>
              <p>
                Udaipur Animal Feed tries to feed all the animals across the
                city with food as well as love.
              </p>
            </div>
          </div>
        </div>
